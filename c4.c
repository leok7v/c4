    ...
    while ((tk = *p)) {
        ...
        if (tk == '\n') {
            if (src) {
                ...
                lp = p;
                while (le < e) {
                    printf("%8.4s", &"LEA ,IMM ,JMP ,JSR ,BZ  ,BNZ ,ENT ,ADJ ,"
        ...
        if (m[0] == id[Hash]) {
            ...
            *++e = ADD;
            ...
            if (ty == CHAR) {
                ...
                *++e = LI32;
            } else if (ty > INT64 && ty < PTR) {
                // nested struct, keep address
            } else {
                *++e = LI;
            }
            t = 1;
    ...
    if (!tk) {
        ...
        *++e = IMM;
        if (ty == CHAR) {
            ...
            *++e = ((int64_t *)struct_syms[ty - INT64 - 1])[Val];
        } else {
            *++e = sizeof(int64_t);
        }
        ty = INT64;
        ...
        if (tk == '(') {
            ...
            *++e = d[Val];
            ...
            if (d[Extent]) {
                // array: address is the value
            } else if (ty == CHAR) {
                *++e = LC;
            } else if (ty == INT32) {
                *++e = LI32;
            } else if (ty > INT64 && ty < PTR) {
                // struct value, keep address
            } else {
                *++e = LI;
            }
        }
        ...
        if (*e == LC || *e == LI32 || *e == LI) {
            ...
            // struct value, address already in accumulator
        } else {
        ...
        *++e = IMM;
        if (ty > PTR) {
            ...
            if (base_ty == CHAR) {
                ...
                *++e = 4;
            } else if (base_ty > INT64 && base_ty < PTR) {
            ...
            *++e = PSH;
            ...
            if (t > INT64) {
                ...
                *++e = IMM;
                ...
                if (elem_ty == CHAR) {
                    *++e = sizeof(char);
                } else if (elem_ty == INT32) {
                    *++e = 4;
                } else if (elem_ty > INT64 && elem_ty < PTR) {
                    *++e = ((int64_t *)struct_syms[elem_ty - INT64 - 1])[Val];
                } else {
                    *++e = sizeof(int64_t);
                }
                *++e = MUL;
            } else {
                printf("%d: bad pointer in index\n", (int)line);
                exit(-1);
            }
            *++e = ADD;
            ty = t - PTR;
...
void stmt() {
    ...
    if (tk == If) {
        ...
        *++e = LEV;
        ...
        next();
        mark = scope_sp;
        while (tk == Int || tk == Int32_t || tk == Int64_t || tk == Char
               || tk == Struct) {
            if (tk == Struct) {
                next();
                if (tk != Id) {
            ...
            while (tk != ';') {
                ...
                if (tk == Brak) {
                    ...
                    if (ty == CHAR) {
                        ...
                        i = i + (ival * ((int64_t *)struct_syms[ty - INT64 - 1])[Val] + 7) / 8;
                    } else {
                        i = i + ival;
                    }
                    id[Type] = ty + PTR;
                } else if (ty > INT64 && ty < PTR) {
                    i = i + (((int64_t *)struct_syms[ty - INT64 - 1])[Val] + 7) / 8;
                } else {
                    ++i;
                }
                id[Val] = i;
...
int main(int argc, char **argv) {
    ...
    while (tk) {
        ...
        if (tk == Int) {
            ...
            if (tk == '{') {
                s = id;
                s[Class] = Struct;
                if (num_structs >= PTR - INT64 - 1) {
                    printf("%d: too many structs\n", (int)line);
                    return -1;
                }
                ...
                while (tk != '}') {
                    ...
                    if (tk == Int) {
                        ...
                        next();
                        if (tk == '{') {
                            printf("%d: nested structs not supported\n", (int)line);
                            return -1;
                        }
                        if (id[Class] == Struct) {
                            bt = id[Type];
                    ...
                    while (tk != ';') {
                        ...
                        if (id[Class] == Loc) {
                            printf("%d: duplicate struct member definition\n", (int)line);
                            return -1;
                        }
                        ...
                        if (ty == CHAR) {
                            ...
                            i = i + ((int64_t *)struct_syms[ty - INT64 - 1])[Val];
                        } else {
                            i = i + sizeof(int64_t);
                        }
                ...
                *++e = ENT;
                ...
                while (tk == Int || tk == Int32_t || tk == Int64_t || tk == Char
                    ...
                    if (tk == Struct) {
                        ...
                        if (id[Class] == Struct) {
                            bt = id[Type]; // copy the Struct ID
                        } else {
                            printf("%d: %s not a struct\n", (int)line, (char *)id[Name]);
                            return -1;
                        }
                        next();
                    } else {
                ...
                *++e = LEV;
                ...
                if (tk == Brak) {
                    ...
                    if (ty == CHAR) {
                        ...
                        data = data + ival * ((int64_t *)struct_syms[ty - INT64 - 1])[Val];
                    } else {
                        data = data + ival * sizeof(int64_t);
                    }
                    id[Type] = ty + PTR;
                } else if (ty == CHAR) {
                    ...
                    data = data + ((int64_t *)struct_syms[ty - INT64 - 1])[Val];
                } else {
    ...
    *--sp = (int64_t)t;
    ...
    while (1) {
        ...
        if (debug) {
            printf("%lld> %.4s", cycle,
                   &"LEA ,IMM ,JMP ,JSR ,BZ  ,BNZ ,ENT ,ADJ ,LEV ,LI  ,LC  ,LI32,"
                    "SI  ,SC  ,SI32,PSH ,OR  ,XOR ,AND ,EQ  ,NE  ,LT  ,GT  ,LE  ,"
                    "GE  ,SHL ,SHR ,ADD ,SUB ,MUL ,DIV ,MOD ,OPEN,READ,CLOS,PRTF,"
                    "MALC,FREE,MSET,MCMP,EXIT,WRIT,SYST,POPN,PCLS,FRED,MCPY,MMOV,"
                    "SCPY,SCMP,SLEN,SCAT,SNCM,"[i * 5]);
            if (i <= ADJ) {
                printf(" %lld\n", *pc);
            } else {
                printf("\n");
        ...
        if (i == LEA) {
            a = (int64_t)(bp + *pc++); // load local address
        } else if (i == IMM) {
            ...
            *--sp = (int64_t)(pc + 1);
            ...
            pc = a ? pc + 1 : (int64_t *)*pc; // branch if zero
        } else if (i == BNZ) {
            pc = a ? (int64_t *)*pc : pc + 1; // branch if not zero
        } else if (i == ENT) {
            *--sp = (int64_t)bp;
            bp = sp;
            sp = sp - *pc++;
            ...
            a = *(int64_t *)a; // load int64
        } else if (i == LC) {
            a = *(char *)a; // load char
        } else if (i == LI32) {
            a = *(int32_t *)a; // load int32 (sign-extend)
        } else if (i == SI) {
            *(int64_t *)*sp++ = a; // store int64
        } else if (i == SC) {
            a = *(char *)*sp++ = a; // store char
        } else if (i == SI32) {
            *(int32_t *)*sp++ = (int32_t)a; // store int32
        } else if (i == PSH) {
            *--sp = a; // push
        } else if (i == OR) {
            a = *sp++ | a;
            ...
            a = (int64_t)memset((char *)sp[2], sp[1], *sp);
        } else if (i == MCMP) {
            ...
            a = write(sp[2], (char *)sp[1], *sp);
        } else if (i == SYST) {
            a = system((char *)*sp);
        } else if (i == POPN) {
            a = (int64_t)popen((char *)sp[1], (char *)*sp);
        } else if (i == PCLS) {
            a = pclose((void *)*sp);
        } else if (i == FRED) {
            a = fread((void *)sp[3], sp[2], sp[1], (void *)*sp);
        } else if (i == MCPY) {
            a = (int64_t)memcpy((char *)sp[2], (char *)sp[1], *sp);
        } else if (i == MMOV) {
            a = (int64_t)memmove((char *)sp[2], (char *)sp[1], *sp);
        } else if (i == SCPY) {
            a = (int64_t)strcpy((char *)sp[1], (char *)*sp);
        } else if (i == SCMP) {
            a = strcmp((char *)sp[1], (char *)*sp);
        } else if (i == SLEN) {
            a = strlen((char *)*sp);
        } else if (i == SCAT) {
